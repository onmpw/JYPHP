...
class makeWSDL_Java{
    ...
    public function getWSDL(){
        ...
        $headerWsdl .= $messtemplate.$porttypetemplate.$bindingtemplate.$servicetemplate."</wsdl:definitions>";
    ...
    private function bindingTemplate($methods){
        $operattemplate = "";
        for($i = 0 ; $i<count($methods) ; $i++){
            $operattemplate .= "\t<wsdl:operation name='{$methods[$i]->getName()}'>\r\n\t<soap:operation soapAction='' />\r\n\t\t<wsdl:input>\r\n\t\t\t<soap:body encodingStyle='http://schemas.xmlsoap.org/soap/encoding/' namespace='{$this->targetNamespace}' use='encoded' />\r\n\t\t</wsdl:input>\r\n\t\t<wsdl:output>\r\n\t\t\t<soap:body encodingStyle='http://schemas.xmlsoap.org/soap/encoding/' namespace='{$this->targetNamespace}' use='encoded' />\r\n\t\t</wsdl:output>\r\n\t</wsdl:operation>\r\n";
        }
        $bindingtemplate = "<wsdl:binding name='{$this->service_name}SOAP' type='tns:{$this->service_name}'>\r\n<soap:binding style='rpc' transport='http://schemas.xmlsoap.org/soap/http' />\r\n{$operattemplate}</wsdl:binding>\r\n";
        return $bindingtemplate;
    }
    private function serviceTemplate(){
        return "<wsdl:service name='{$this->service_name}'>\r\n\t<wsdl:port binding='tns:{$this->service_name}SOAP' name='{$this->service_name}SOAP'>\r\n\t\t<soap:address location='{$this->uri}/{$this->serverfile}'/>\r\n\t</wsdl:port>\r\n</wsdl:service>";
    }
}