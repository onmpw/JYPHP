...
function autoload($classname){
    require_once SMARTY_SYSPLUGINS_DIR . strtolower($classname).'.php';
}

/* require_once SMARTY_SYSPLUGINS_DIR . 'smarty_internal_templatebase.php';
require_once SMARTY_SYSPLUGINS_DIR . 'smarty_internal_templatecompilerbase.php';
require_once SMARTY_SYSPLUGINS_DIR . 'smarty_internal_templatelexer.php' ;
require_once SMARTY_SYSPLUGINS_DIR . 'smarty_internal_template.php';
require_once SMARTY_SYSPLUGINS_DIR . 'smarty_internal_templateparser.php';
